...
In the "Home" section press "Settings" in the menu on the left-hand side and then press "Secrets". You will find a predefined form where you can choose between an RSA-key and a Paillier-key. You can define the ...
...
On the right sight, you will then find all already stored keys with specific name as list below the "Overview" and the search bar (where you can filter after a specific key in the list)
...
!!! warning
      ...
      "...all the proposals created by this station"
...
!!! warning
      What does Group actually mean? (It's not the programming language,is it?)

      Why is leuko-expert / cord in "Group"?
...
- ... the risk level and specifies it by context in the risk comment. "Low" means | "Mid" | "High"
...
!!! warning
      Possible Risk descriptions?
      Usually it should be safe. So no risk at all in all cases,isn't it?
...
!!! warning
      Why is it possible to change the MasterImage-Settings?
...
!!! Warning
      Why is the public key, necessary. What exactly is it doing at this point?
...
After running throigh all station, you can click on the "Download"-button on point 4.Result. To decrypt the results, you need the [Desktop App (Offline Tool)](./desktop_app.md) again.
