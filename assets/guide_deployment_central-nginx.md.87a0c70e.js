...
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="installer" tabindex="-1">Installer <a class="header-anchor" href="#installer" aria-hidden="true">#</a></h2>`,11),o=[l];function t(r,c,i,A,C,y){return n(),a("div",null,o)}const h=s(p,[["render",t]]);export{_ as __pageData,h as default};
