# Train Creation
Before we can create a new train, we must first create a proposal. If there is no proposal that your train can use, you have created a [Proposal](#train-setup).
